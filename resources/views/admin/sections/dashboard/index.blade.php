                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter($users_invest->count())->number . numeric_unit_converter($users_invest->count())->unit }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--info">{{ __("This Day") }} {{ numeric_unit_converter($this_day_users_invest_balance)->number . numeric_unit_converter($this_day_users_invest_balance)->unit }}</span>
                                    <span class="badge badge--warning">{{ __("This Month") }} {{ numeric_unit_converter($this_month_users_invest_balance)->number . numeric_unit_converter($this_month_users_invest_balance)->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
