                                        ...
                                        <div class="col-xxl-12 col-xl-6 col-lg-6 form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form--control number-input" value="<?php echo e(old("gateway_currency.".$item->currency_code.".rate",$item->rate)); ?>" name="<?php echo e("gateway_currency[".$item->currency_code."][rate]"); ?>">
...
<?php endif; ?><?php /**PATH /home/prosnluk/public_html/resources/views/admin/components/payment-gateway/automatic/gateway-currency.blade.php ENDPATH**/ ?>