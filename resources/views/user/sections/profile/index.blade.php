                            ...
                            <form action="{{ setRoute('user.profile.update') }}" class="form-dashboard user-form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-4k">
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        ...
                                        <input type="text" class="form-control" name="firstname" id="text1" value="{{ old('firstname',auth()->user()->firstname) }}" placeholder="Enter First Name">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="text1" class="form-label ">{{ __("Last Name") }}<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="lastname" id="text1" value="{{ old('lastname',auth()->user()->lastname) }}" placeholder="Enter Last Name">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="text2" class="form-label ">{{ __("Email") }}<span class="text-danger">&nbsp; ({{ __("Not Changable") }})</span></label>
                                        <input type="text" class="form-control" id="text2" readonly value="{{ auth()->user()->email }}" placeholder="Email Address">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="phone" class="form-label ">{{ __("Phone") }}<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="phone" id="phone" value="{{ old('phone',auth()->user()->full_mobile) }}" placeholder="Enter Phone Number">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                    ...
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        ...
                                        <input type="text" class="form-control" id="city" name="city" value="{{ old('city',auth()->user()->address->city ?? "") }}" placeholder="Enter City">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="State" class="form-label ">{{ __("State") }}<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="State" name="state" value="{{ old('state',auth()->user()->address->state ?? "") }}" placeholder="Enter State">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="Address" class="form-label ">{{ __("Address") }}<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="Address" name="address" value="{{ old('address',auth()->user()->address->address ?? "") }}" placeholder="Enter Address">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="Zip Code" class="form-label ">{{ __("Zip Code") }}<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="postal_code" id="Zip Code" value="{{ old('postal_code',auth()->user()->address->zip ?? "") }}" placeholder="Enter Zip Code">
                                    </div>
                                    <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
