                ...
                <div class="card-text">
                    <div class="d-sm-flex d-sm-block justify-content-between">
                        <div class="d-flex">
                            ...
                            <div class="">
                                <h4 class="text-capitalize text-white"><?php echo e(__("Registration Bonus")); ?></h4>
                                ...
                                <span class="badge badge-success"><?php echo e(__("Bonus Added")); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="accordion-body acc">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <h4><?php echo e(__("Registration Bonus")); ?></h4>
                            </div>
                        </div>
                        <hr>
                        <div class="col-12">
...
<?php endif; ?><?php /**PATH /home/prosnluk/public_html/resources/views/user/components/transaction/bonus.blade.php ENDPATH**/ ?>