        ...
        <div class="four-not-four-wrapper">
            ...
            <div class="four-not-four-content">
                ...
                <div class="four-not-four-btn">
                    <a href="<?php echo e(route('frontend.index')); ?>" class="btn--base"><?php echo e(__("Back To Home")); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('errors.custom-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prosnluk/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>