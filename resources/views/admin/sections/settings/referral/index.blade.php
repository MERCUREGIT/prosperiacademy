                    ...
                    <form class="modal-form" method="POST" action="{{ setRoute('admin.settings.referral.package.store') }}">
                        ...
                        <div class="row mb-10-none">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form--control number-input" value="{{ old('commission') }}" name="commission" placeholder ='ex: 2'>
                                    <span class="input-group-text">{{ get_default_currency_code($default_currency) }}</span>
                                </div>
                                @error('commission')
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form--control number-input" value="{{ old('refers') }}" placeholder ='ex: 50', name="refers">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form--control number-input" value="{{ old('invested_amount') }}" placeholder ='ex: 1000', name="invested_amount">
                                    <span class="input-group-text">{{ get_default_currency_code($default_currency) }}</span>
                                </div>
