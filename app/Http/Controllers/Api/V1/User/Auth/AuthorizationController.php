...
class AuthorizationController extends Controller
{
    ...
    public static function sendCodeToMail($user = null) {
        ...
        // if(auth()->guard("api")->check() == false) return Response::error([__("Access denied! Unauthenticated")],[],401);
        ...
        // return Response::success([__("Verification code sended successfully to your mail. Please check your mail inbox/spam to verify")],['token' => $data['token'],"wait_time" => ""],200);
