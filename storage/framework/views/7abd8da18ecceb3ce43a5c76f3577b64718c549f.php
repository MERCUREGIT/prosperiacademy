...
<?php $__env->startSection('content'); ?>
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#about-page-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> <?php echo e(__("Add Item")); ?></a>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $data->value->items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-item="<?php echo e(json_encode($item)); ?>">
                                <td><span class="icon-circle"><i class="<?php echo e($item->icon ?? ""); ?>"></i></span></td>
                                <td><span class="text--dark"><?php echo e($item->language->$system_default_lang->title ?? ""); ?></span></td>
                                <td><span class="text--dark"><?php echo e($item->language->$system_default_lang->description ?? ""); ?></span></td>
                                <td>
    ...
    <?php echo $__env->make('admin.components.modals.site-section.add-about-page-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prosnluk/public_html/resources/views/admin/sections/setup-sections/about-page-section.blade.php ENDPATH**/ ?>