                    ...
                    <tbody>
                        @forelse ($investment_plans as $key => $item)
                            <tr>
                                ...
                                <td>{{ get_amount($item->min_invest,$default_currency->code,4) }}</td>
                                <td>{{ get_amount($item->min_invest_offer,$default_currency->code,4) }}</td>
                                <td>{{ get_amount($item->max_invest,$default_currency->code,4) }}</td>
                                <td>{{ get_amount($item->profit_fixed,$default_currency->code,4) }}</td>
