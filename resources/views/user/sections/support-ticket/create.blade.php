                            ...
                            <form action="{{ setRoute('user.support.ticket.store') }}" role="form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row  mb-20-none">
                                    ...
                                    <div class="col-xl-12 form-group mb-20">
                                        ...
                                        <textarea class="form-control h-75" name="desc" placeholder="Enter Message" aria-label="textarea" rows="4">{{ old('desc') }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-xl-12 form-group mb-30">
                                        <button type="submit" class="btn--base mt-4 w-100">{{ __("Submit") }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
