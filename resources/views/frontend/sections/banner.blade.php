            ...
            <div class="col-lg-6 col-md-12 col-12 my-auto">
                ...
                <div class="d-flex pt-5">
                    <div class="banner-btn-area pe-5">
                        <a href="{{ $banner_sections?->value?->language?->$app_local_lang?->button_link ?? "javascript:void(0)" }}" class="btn--base mt-2">{{ $banner_sections?->value?->language?->$app_local_lang?->button_name ?? "" }}</a>
                    </div>
