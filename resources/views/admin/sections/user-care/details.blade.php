                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter(get_amount($user_wallet?->balance ?? 0,null,4))->number . numeric_unit_converter($user_wallet?->balance ?? 0,null,4)->unit }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--success">{{ __("Success") }} {{ numeric_unit_converter(get_amount($user_success_add_money,null,4))->number . numeric_unit_converter(get_amount($user_success_add_money,null,4))->unit }}</span>
                                    <span class="badge badge--warning">{{ __("Pending") }} {{ numeric_unit_converter(get_amount($user_pending_add_money,null,4))->number . numeric_unit_converter(get_amount($user_pending_add_money,null,4))->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter(get_amount($user_total_transactions,null,4))->number . numeric_unit_converter(get_amount($user_total_transactions,null,4))->unit }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __("Send") }} {{ numeric_unit_converter(get_amount($user_send_total,null,4))->number . numeric_unit_converter($user_send_total)->unit }}</span>
                                    <span class="badge badge--success">{{ __("Receive") }} {{ numeric_unit_converter(get_amount($user_receive_total,null,4))->number . numeric_unit_converter($user_receive_total)->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter(get_amount($user_money_out,null,4))->number . numeric_unit_converter(get_amount($user_money_out,null,4))->unit }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __("Canceled") }} {{ numeric_unit_converter(get_amount($user_reject_money_out,null,4))->number . numeric_unit_converter(get_amount($user_reject_money_out,null,4))->unit }}</span>
                                    <span class="badge badge--warning">{{ __("Pending") }} {{ numeric_unit_converter(get_amount($user_pending_money_out,null,4))->number . numeric_unit_converter(get_amount($user_pending_money_out,null,4))->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-badge">
                                    <span class="badge badge--success">{{ __("Complete") }} {{ numeric_unit_converter(get_amount($complete_invest_plans,null,4))->number . numeric_unit_converter(get_amount($complete_invest_plans,null,4))->unit }}</span>
                                    <span class="badge badge--warning">{{ __("Ongoing") }} {{ numeric_unit_converter(get_amount($ongoing_invest_plans,null,4))->number . numeric_unit_converter(get_amount($ongoing_invest_plans,null,4))->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter(get_amount($total_invest_amount,null,4))->number . numeric_unit_converter(get_amount($total_invest_amount,null,4))->unit }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--success">{{ __("Complete") }} {{ numeric_unit_converter(get_amount($complete_invest_amount,null,4))->number . numeric_unit_converter(get_amount($complete_invest_amount,null,4))->unit }}</span>
                                    <span class="badge badge--warning">{{ __("Ongoing") }} {{ numeric_unit_converter(get_amount($ongoing_invest_amount,null,4))->number . numeric_unit_converter(get_amount($ongoing_invest_amount,null,4))->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter(get_amount($total_profit_amount,null,4))->number . numeric_unit_converter(get_amount($total_profit_amount,null,4))->unit }}</h2>
                                </div>
                                <div class="user-badge">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $default_currency->symbol }} {{ numeric_unit_converter(get_amount($total_money_transfer,null,4))->number . numeric_unit_converter(get_amount($total_money_transfer,null,4))->unit }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--success">{{ __("Complete") }} {{ numeric_unit_converter(get_amount($success_money_transfer,null,4))->number . numeric_unit_converter(get_amount($success_money_transfer,null,4))->unit }}</span>
                                    <span class="badge badge--warning">{{ __("Pending") }} {{ numeric_unit_converter(get_amount($pending_money_transfer,null,4))->number . numeric_unit_converter(get_amount($pending_money_transfer,null,4))->unit }}</span>
                                </div>
                            </div>
                            <div class="right">
