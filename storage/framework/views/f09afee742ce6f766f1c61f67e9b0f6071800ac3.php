<div id="service-add" class="mfp-hide large">
    <div class="modal-data">
        <div class="modal-header px-0">
            <h5 class="modal-title"><?php echo e(__("Add Service")); ?></h5>
        </div>
...
</div><?php /**PATH /home/prosnluk/public_html/resources/views/admin/components/modals/site-section/add-service-item.blade.php ENDPATH**/ ?>