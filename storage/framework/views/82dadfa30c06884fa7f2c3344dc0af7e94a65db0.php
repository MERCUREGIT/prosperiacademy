    ...
    <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td><span><?php echo e($item->username); ?></span></td>
                <td><?php echo e($item->email); ?></td>
                <td><?php echo e($item->full_mobile); ?></td>
                <td>
...
</table><?php /**PATH /home/prosnluk/public_html/resources/views/admin/components/data-table/user-table.blade.php ENDPATH**/ ?>