    ...
    <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td><span class="text--info"><?php echo e($item->receiver?->email); ?></span></td>
                ...
                <td>
                    ...
                    <a href="<?php echo e(setRoute('admin.money.transfer.details',$item->trx_id)); ?>" class="btn btn--base"><i class="las la-expand"></i></a>
                </td>
            </tr>
...
</table><?php /**PATH /home/prosnluk/public_html/resources/views/admin/components/data-table/money-transfer-table.blade.php ENDPATH**/ ?>