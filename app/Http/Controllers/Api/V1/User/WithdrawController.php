...
class WithdrawController extends Controller
{
    ...
    public function submit(Request $request) {
        ...
        $exchange_request_amount = $charges->exchange_rate * $charges->request_amount;
        $gateway_min_limit = $gateway_currency->min_limit;
        $gateway_max_limit = $gateway_currency->max_limit;
