        ...
        <div class="card-body">
            <form class="card-form" method="POST" action="<?php echo e(setRoute('admin.web.settings.basic.settings.update')); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 form-group">
                        <label><?php echo e(__("Site Secondary Color")); ?>*</label>
                        <div class="picker">
                            <input type="color" value="<?php echo e(old('secondary_color',$basic_settings->secondary_color)); ?>" class="color color-picker">
                            <input type="text" autocomplete="off" spellcheck="false" class="color-input" value="<?php echo e(old('secondary_color',$basic_settings->secondary_color)); ?>" name="secondary_color">
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prosnluk/public_html/resources/views/admin/sections/web-settings/basic-settings.blade.php ENDPATH**/ ?>