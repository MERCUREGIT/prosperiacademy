    ...
    <form action="<?php echo e(setRoute('admin.payment.gateway.update',['add-money','automatic',$gateway->alias])); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="custom-card credentials">
            <div class="card-header">
                ...
                <?php if($gateway->isCrypto()): ?>
                    <span class="badge badge--success"><?php echo e(__("Crypto")); ?></span>
                <?php endif; ?>
            </div>
            <div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prosnluk/public_html/resources/views/admin/sections/payment-gateways/add-money/automatic/edit.blade.php ENDPATH**/ ?>